                                ...
                                <div class="page-content">
                                    <div class="sign-container">
                                        ...
                                        <div class="sign-container-d">
                                            <div class="right-box">
                                                <form method="POST" action="{{asset('loginwithphone')}}">
                                                @csrf
                                                    <h6>تسجيل دخول</h6>
                                                    ...
                                                    <div>
                                                        <div>
                                                            ...
                                                            <input type="text" name="phone" required placeholder=" رقم الجوال 00966560000000" />
                                                            @if ($errors->has('phone'))
                                                    ...
                                                    <button type="submit" class="btn-red">تحقق</button>
                                                    ...
                                                    <div class="sign-social">
                                                        <a href="redirect/facebook"><i class="icon-facebook"></i></a>
                                                        <a href="redirect/google"><i class="fa fa-google-plus-square"></i></a>
                                                    </div>
                                                </form>
                                            </div>

...
@section('title') {{__('messages.sitename')}} | {{__('messages.privacy')}} @endsection
@section('content')
                ...
                <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="themesflat-headings style-1 clearfix text-center">
                                <h2 style="font-size: 25px;font-weight: 700; letter-spacing: 0;color: #37405a">سياسة الخصوصية</h2>
                                <div class="sep"></div>
                ...
                <div class="col-md-12">
                    <div class="row join">
                        <div class="col-md-12">
                                ...
                                <div class="themesflat-headings style-1 clearfix text-center">
                                    <div>
                                        <p>لدينا فريق محترف لمساعدتك سواء كان من خلال مركز خدمة البائعين او من خلال قسم التطوير
                                        خلال مركز خدمة البائعين او من خلال قسم التطوير
                                            خلال مركز خدمة البائعين او من خلال قسم التطوير
                                        </p>
                                    </div>
                                    <div class="clearfix"></div>

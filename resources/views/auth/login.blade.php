                                            ...
                                            <div class="right-box">
                                                ...
                                                @csrf
                                                    ...
                                                    @if ($errors->has('email') || $errors->has('password'))
                                                        <span class="error">رجاء إدخال البيانات بشكل سليم</span>
                                                    @endif
                                                    ...
                                                    <button type="submit" class="btn-red">تسجيل دخول</button>
                                                    
                                                    <div class="signin">
                                                        <a href="{{asset('/signinphone')}}">
                                                    ...
                                                    <div class="sign-social">
                                                        ...
                                                        <a href="redirect/google"><i class="fa fa-google-plus"></i></a>
                                                    </div>
                                                </form>
                                            </div>

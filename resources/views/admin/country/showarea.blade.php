...
@section('title') لوحة التحكم | مشاهدة المدن  @endsection
@section('content')
<style>
...
<section class="content">
        ...
        <div class="box-header">
                <h3 class="box-title"> إضافة مدينة داخل هذة الدولة</h3>
            </div>
                <div class="box ">
            ...
            <div class="table-responsive box-body">
                <table  class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{asset('adminpanel/cities/'.$area->id)}}" style="margin-bottom: 0em;" class="btn btn-block btn-info">مشاهدة الاحياء</a>
                        </th>

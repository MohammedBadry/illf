...
@section('title') {{__('messages.sitename')}} | {{__('messages.support')}} @endsection
@section('content')
                    ...
                    <div class="col-md-12">
                            <div class="col-md-12">
                                <div class="themesflat-headings style-1 clearfix text-center">
                                    <h2 style="font-size: 25px;font-weight: 700; letter-spacing: 0;color: #37405a">{{__('messages.support')}}</h2>
                                    <div class="sep"></div>

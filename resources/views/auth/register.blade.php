                                    ...
                                    <div class="sign-container">
                                        ...
                                        <div class="sign-container-d">
                                            <div class="right-box">
                                                ...
                                                @csrf 
                                                    <h6>إنشاء حساب</h6>
                                                    <p>فضلا قم بتسجيل الدخول لكي تتمكن من الدخول معنا</p>
                                                    <div>
                                                        <div>
                                                            <i class="fa icon-account"></i>
                                                            <input type="text" name="name" value="{{old('name')}}" required placeholder="الاسم" /><br>
                                                            @if ($errors->has('name'))
                                                    ...
                                                    <div>
                                                        <div>
                                                            ...
                                                            <input type="email" name="email" value="{{old('email')}}" required placeholder="البريد الالكتروني" /><br>
                                                            @if ($errors->has('email'))
                                                    ...
                                                    <div>
                                                        <div>
                                                            <label><input type="checkbox" required/> أوافق علي الشروط والاحكام</label>         
                                                        </div>
                                                    </div>

                                                    <button type="submit" class="btn-red">انشاء حساب</button>
                                                    <div class="signin">
                                                        <p>هل تمتلك حساب بالفعل ؟ </p>
